...
for epoch in range(100):
    ...
    # save model
    torch.save(model.state_dict(), "googlenet-last.pt")
    if acc_val == max(val_acc_list):
        torch.save(model.state_dict(), "googlenet-best.pt")
...
plt.savefig(r'D:\qianmengchen\water depth prediction\GoogleNet+classification\结果分析图\googlenet-512-1e-4-数增-1e-4.png')
plt.show()